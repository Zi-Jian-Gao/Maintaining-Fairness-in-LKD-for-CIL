...
class BiC(BaseLearner):
    ...
    def _run(self, train_loader, test_loader, optimizer, scheduler, stage):
        if self._cur_task == 0 and self.loadpre == 0:
            model_path = f"imagenet_bic_seed1993_half.pth"
            ...
            for epoch in range(1, epochs + 1):
                    ...
                    if stage == "training":
                        ...
                        if self._old_network is not None:
                            ...
                            if self.method == "normal":
                                ...
                                distill_loss = DistillKL_logit_stand(
                                ...
                                distill_loss = (loss_kd1 + loss_kd2)/2
                ...
                logging.info(info)
            # if self._cur_task == 0:
            #     model_save_path = f"imagenet_bic_seed1993_half.pth"
