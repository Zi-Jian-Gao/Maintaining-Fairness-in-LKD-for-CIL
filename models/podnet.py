...
class PODNet(BaseLearner):
    ...
    def _run(self, train_loader, test_loader, optimizer, scheduler, epk):
        if self._cur_task == 0 and self.loadpre == 0:
            model_path = f"imagenet_podnet_model_seed1993_half.pth"
            ...
            for epoch in range(1, epk + 1):
                ...
                for i, (_, inputs, targets) in enumerate(train_loader):
                    ...
                    if self._old_network is not None:
                        ...
                        old_features = old_outputs["features"].detach()
                        ...
                        if self.method == "normal":
                            ...
                            flat_loss = (loss_kd) * self.factor * lambda_f_base
